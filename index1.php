    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered text-center alighn-middle">
            ...
            <tr>
                ...
                <td><?=$nilai?></td>
                <td>
                <button id="myButton" data-params='{"id":"<?=$ids?>", "nama":"<?=$nama?>", "kelas":"<?=$kelas?>", "nilai":"<?=$nilai?>"}' onclick="handleClick(event)" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal">Edit</button>
                </td>
            </tr>
            <?php
                }
        ...
        <script>
            ...
            function myFunction(params) {
                ...
                var idn = document.getElementById("idnys");
                var nma = document.getElementById("ns");
                var nli = document.getElementById("nl");
                    
                idn.value = params.id;
                nma.value = params.nama;
                nli.value = params.nilai;

                let opts = document.getElementsByClassName("opt"); //opt > nama class pada select opteion kelas di siswa_update.php
                for(let i = 0; i < opts.length; i++){
                    if(opts[i].value == params.kelas){
